namespace KukjeLPR.ROOT.CIMV2 {
    ...
    // ShouldSerialize<PropertyName> 함수는 VS 속성 브라우저에서 특정 속성이 serialize되었는지 여부를 확인하는 데 사용됩니다. 이 함수는 모든 ValueType 속성(null로 설정할 수 없는 Int32 형식, BOOL 형식 등의 속성)에 추가됩니다. 이 함수는 Is<PropertyName>Null 함수를 사용하며 Visual studio에서 끌어서 놓기를 수행할 때 속성 브라우저에 빈 값이 표시되도록 해당 속성의 NULL 값을 확인하는 TypeConverter 구현에도 사용됩니다.
    // Is<PropertyName>Null() 함수는 속성이 NULL인지 확인하는 데 사용합니다.
    // Reset<PropertyName> 함수가 NULL을 허용하는 Read/Write 속성에 추가되었습니다. 이 함수는 속성 브라우저의 VS 디자이너에서 속성을 NULL로 설정하는 데 사용됩니다.
    ...
    // WMI 클래스에 생성된 초기 바인딩 클래스입니다.Win32_OperatingSystem
    public class OperatingSystem0 : System.ComponentModel.Component {
        
        // 클래스가 있는 WMI 네임스페이스를 보유하기 위한 private 속성입니다.
        private static string CreatedWmiNamespace = "ROOT\\CIMV2";
        
        // 이 클래스를 만든 WMI 클래스의 이름을 보유하기 위한 Private 속성입니다.
        private static string CreatedClassName = "Win32_OperatingSystem";
        
        // 여러 메서드에서 사용되는 ManagementScope를 보유하기 위한 private 멤버 변수입니다.
        private static System.Management.ManagementScope statMgmtScope = null;
        
        private ManagementSystemProperties PrivateSystemProperties;
        
        // 기본 lateBound WMI 개체입니다.
        ...
        public OperatingSystem0(System.Management.ManagementObject theObject) {
            ...
            if ((CheckIfProperClass(theObject) == true)) {
                ...
                throw new System.ArgumentException("클래스 이름이 일치하지 않습니다.");
            }
        }
        ...
        // 여러 메서드에서 사용되는 public static 범위 속성입니다.
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
